...
const Hero = () => {
  return (
    <div className="relative h-screen w-full flex justify-center flex-col">
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* text xontent */}
        <div data-aos="fade-up">
          {/* Box text */}
          <BoxText text="Digital E-book" />
          {/* Heading */}
          <h1 className="text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 dark:text-white ">
          ...
          <p className="text-xs sm:text-sm md:text-base font-medium text-gray-700 dark:text-gray-500">
            Unlock your potential with ebooks that offer guidance on
            self-improvement, productivity, and career advancement. Perfect for
            building the skills and mindset needed to succeed in all areas of
            life.
          </p>
          {/* Buttons */}
        ...
        <div
          data-aos="fade-down"
          data-aos-delay="150"
          className="mx-auto hidden lg:block rounded-t-full"
        >
          <Image
            src="/images/hero.jpg"
            alt="image"
